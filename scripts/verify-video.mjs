...
process.stdout.write(`Video verification passed: ${media.width}x${media.height}, H.264/AAC ${media.audioChannels}ch, ${media.colorSpace}/${media.colorRange}, ${media.frameRate}, ${media.frameCount} frames, ${media.duration}s, ${media.integratedLoudness} LUFS, ${media.truePeak} dBTP.\n`);
